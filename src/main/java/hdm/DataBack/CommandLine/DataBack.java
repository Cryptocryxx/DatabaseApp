...
public class DataBack implements Callable<Integer> {
    ...
    public static void main(String[] args) {
        int exitCode = new CommandLine(new DataBack())
                ...
                .execute(args);
        System.out.println("\033[1;226m" + """
                
                ------------------------------------------------------------------------------------------------
                 _______       ___   .___________.    ___      .______        ___       ______  __  ___\s
                |       \\     /   \\  |           |   /   \\     |   _  \\      /   \\     /      ||  |/  /\s
                |  .--.  |   /  ^  \\ `---|  |----`  /  ^  \\    |  |_)  |    /  ^  \\   |  ,----'|  '  / \s
                |  |  |  |  /  /_\\  \\    |  |      /  /_\\  \\   |   _  <    /  /_\\  \\  |  |     |    <  \s
                |  '--'  | /  _____  \\   |  |     /  _____  \\  |  |_)  |  /  _____  \\ |  `----.|  .  \\ \s
                |_______/ /__/     \\__\\  |__|    /__/     \\__\\ |______/  /__/     \\__\\ \\______||__|\\__\\\s
                -------------------------------------------------------------------------------------------------
